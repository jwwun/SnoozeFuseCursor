    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            Text("• $125 total → Adding a snooze button")
                .font(.system(size: 15, design: .rounded))
                .foregroundColor(.white.opacity(0.9))
            Text("• $150 total → I'll voice act a custom alarm sound in Japanese and English")
                .font(.system(size: 15, design: .rounded))
                .foregroundColor(.white.opacity(0.9))
            Text("• $175 total → Unlocking hourly timer support")
                .font(.system(size: 15, design: .rounded))
                .foregroundColor(.white.opacity(0.9))
            Text("• $200 total → Expanding hourly timer features")
                .font(.system(size: 15, design: .rounded))
                .foregroundColor(.white.opacity(0.9))
            Text("• $600 total → I can pay rent for a month 😅")
                .font(.system(size: 15, design: .rounded))
                .foregroundColor(.white.opacity(0.9))
